//
// Created by Vladislav on 30.05.2022.
//

#ifndef LAB04_HASHTABLE_H
#define LAB04_HASHTABLE_H
#include <iterator>
#include <vector>
#include <string>
#include <iostream>
...
public:
    static const size_t buckets_counter = 5000; // К-во сегментов в демо-варианте
...
//    std::cout << tag << ':' << std::endl;
    std::cout << "Sequence: ";
//    sequence = std::vector<int>{begin(), end()};
